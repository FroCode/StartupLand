            ...
            <div className="mockupTexts   ">
                ...
                <h4 className='text-[#0F2137] font-bold text-4xl pb-5 pt-5 	'>Meet our premium features <br />
                    ...
                    <div className="containButtons ">
                        <div className="singleButton font-bold flex text-[#0F2137] text-lg p-5 rounded bg-[#F6F8FB] ">
                        Collaborate your multiple team support easily  <i className='p-2'>{arrowRight}</i>
                        </div>
                        <div className="singleButton font-bold flex text-[#0F2137] mt-4 rounded bg-[#F6F8FB] text-lg  p-5">
